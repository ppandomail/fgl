...
_lr_productions = [
  ...
  ('instrucciones -> instruccion instrucciones','instrucciones',2,'p_instrucciones_lista','gramatica.py',55),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones_lista','gramatica.py',56),
  ('instruccion -> REVALUAR CORIZQ expresion CORDER PTCOMA','instruccion',5,'p_instrucciones_evaluar','gramatica.py',59),
  ('expresion -> expresion MAS expresion','expresion',3,'p_expresion_binaria','gramatica.py',63),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_expresion_binaria','gramatica.py',64),
  ('expresion -> expresion POR expresion','expresion',3,'p_expresion_binaria','gramatica.py',65),
  ('expresion -> expresion DIVIDIDO expresion','expresion',3,'p_expresion_binaria','gramatica.py',66),
  ('expresion -> MENOS expresion','expresion',2,'p_expresion_unaria','gramatica.py',73),
  ('expresion -> PARIZQ expresion PARDER','expresion',3,'p_expresion_agrupacion','gramatica.py',77),
  ('expresion -> ENTERO','expresion',1,'p_expresion_number','gramatica.py',81),
  ('expresion -> DECIMAL','expresion',1,'p_expresion_number','gramatica.py',82),
]
